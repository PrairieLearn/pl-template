...
1. Real-time help assistance on PrairieLearn's [`#pl-help` Slack channel](https://prairielearn.com/slack).
1. Look up the question on the [Frequently Asked Question (FAQ) page](https://prairielearn.readthedocs.io/en/latest/faq/) and [GitHub Discussions](https://github.com/PrairieLearn/PrairieLearn/discussions/categories/q-a).
1. Attend virtual office hours, which are announced at the start of the semester on PrairieLearn's [Slack](https://prairielearn.com/slack)
